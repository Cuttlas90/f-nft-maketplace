        ...
        <div className="col-sm-11">
          <section >
            <div className=" d-flex justify-content-between">
              <h5>Fractionals NFT: <small className="update">(Live market FNFT Tokens)</small></h5>
              <button className="btn showBtn" onClick={(e) => ShowToggle(e, "auctionCard")}>Show All</button>
            </div>
            <div className="container">
              <div id="auctionCard" className="row auctionCard">
                {NFTs.list.map((row, index) =>
                  row.isFractional &&
          ...
          <section >
            <div className="d-flex justify-content-between">
              <h5>Top Trend Flow NFT:<small className="update"></small> </h5>
              <button className="btn showBtn" onClick={(e) => ShowToggle(e, "MarketNews")}>Show All</button>
            </div>
            <div className="container">
              <div id="MarketNews" className="row auctionCard">
                {NFTs.list.map((row, index) =>
                  !row.isFractional &&
                  <div key={index} className="col-xl-3 col-lg-4 col-md-5 col-sm-6 py-2">
                    <Card1 info={row}></Card1>
