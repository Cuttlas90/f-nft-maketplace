        ...
        <div className="containerCard1">
            ...
            <div id={"C" + props.info.idnft} className="card">
                ...
                <div className="contentBx">
                    <h2 className='nameElips'>{props.info.name}</h2>
                    <div className="size">
                    ...
                    {props.info.isFractional
                        ? <Link to={"/ShowFNFT/" + props.info.chain + "/" + props.info.address + "/" + props.info.tokenId}>More Info</Link>
                        : <Link to={"/ShowNFT/" + props.info.chain + "/" + props.info.address + "/" + props.info.tokenId}>More Info</Link>
                    }
                </div>
            </div>
        </div>
